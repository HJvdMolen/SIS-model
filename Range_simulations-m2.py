...
print("R₀; D; R₁; R₂; v(∞); μ(v); σ(v); #steps; #runs; #nodes; network=directed")

for y in range(8,11):             # basic reproduction number = β.k / δ  
    g.r0 = r0 = y / 4
    for x in range(5):
        ...
        print(f"{r0:.2f}; {g.D:.2f}; {p1.r0:.2f}; {p2.r0:.2f}; {g.v_8:.5f}; {mu:.5f}; {sd:.5f}; {no_of_steps}; {no_of_runs}; {network_size}; {directed}")
